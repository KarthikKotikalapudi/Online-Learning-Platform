...
function SentStudent() {
  ...
  return (
    <div className='inbox-student'>
      <Student_sidebar />
      <div className="inbox-content-student">
        {/* <Navbar/> */}
        ...
        <div className="main-content-inbox-student">
          ...
          <div className="action-sent">
            <Link to={`/student/${studentID}/inbox`}><button className="btn btn-primary mx-3 my-3">Inbox</button></Link>
            <Link to={`/student/${studentID}/inbox/compose`} state={{ sender: '' ,subject:'' }}><button className="btn-primary btn mx-3 my-3">Compose</button></Link>
          </div>
