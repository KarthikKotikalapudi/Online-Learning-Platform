...
function SentInstructor() {
    ...
    const genData=async()=>{
        ...
        // dataRef.current=d
        // filterRef.current=d
        let response=await axios.get(`http://192.168.51.89:5001/messages/sent/prof/${instructorID}`)
     ...
     <div className="inbox-content">
        ...
        <div className="main-content-inbox">
            ...
            <div className="action-sent">
               <Link to={`/instructor/${instructorID}/inbox`}><button className="btn btn-primary mx-3 my-3">Inbox</button></Link> 
