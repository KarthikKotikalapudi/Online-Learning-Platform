...
const handleSubmit=async()=>{
  ...
  let d = {"username": ref1.current.value ,"email": ref2.current.value, "expertise": ref3.current.value ,"age": ref4.current.value, "phoneno": ref5.current.value, "password": ref6.current.value , "confirm_password": ref7.current.value,"image": item.image }
      ...
      <div className="newContainer">
        ...
        <div className="bottom-new">
            ...
            <div className="right-new">
              ...
              <input type="text" ref={ref1} placeholder="Username"/>
              </div>
              <div className="formInput" >
                  <label htmlFor="">
                  Email
                ...
                <label htmlFor="">
                  ...
                  <input type="text" ref={ref3} placeholder="Subject"/>  
                </div>
                  <div className="formInput" >
                <label htmlFor="">
                  Age
